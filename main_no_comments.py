...
class Pipeline:
    def __init__(self, config: dict, session_manager=None) -> None:
        ...
        self.max_cached_frames = config.get("max_cached_frames", 18000)                       
        ...
        self.ecg_buffer = []
        self.ecg_window_size = config.get("ecg_window_size", 1024)         
    ...
    try:
        ...
        while True:
            if False:
                msg = {
                    "start_capture": {
                        "patient_info": {"name": "Test Patient", "age": 30, "gender": "male"},         
                        "time": time.time()         
                    }
                }
            ...
            elif current_status and data_acquisition_status:                  
                with pipeline.cache_lock:
                    cached_count = len(pipeline.cached_frames)
                if cached_count > 0:              
